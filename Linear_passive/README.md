...
Note that the data used for identication is noisy. <img src="figs/noisy_data_nominal.png">
We compare the performance of the baseline system model and the perturbed system model with the nominal system.
 <img src="figs/final_passive.png">
 The fit is also checked using *lsim* and it reports 95.23% for the fit goodness score on the final passive model. 
 <img src="figs/identified.png">
