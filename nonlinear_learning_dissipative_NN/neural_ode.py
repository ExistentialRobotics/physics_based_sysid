...
parser.add_argument('--niters_max', type=int, default=3000) 
...
def visualize(true_y, pred_y, odefunc, itr):
    if args.viz:
        ...
        plt.savefig('Results/Survey_MSD/figs/ini_learning_itr'+str(itr)+'_4164_'+'actv01_nolast'+'.png')
...
if __name__ == '__main__':
    ...
    while (loss>1e-4)  and (itr < args.niters_max):
        ...
        if itr % args.test_freq == 0:
            ...
            ## For saving baseline
            savemat('Results/Survey_MSD/weights_4164_'+str(itr)+'_actv01_nolast'+'.mat', weights)
            savemat('Results/Survey_MSD/biases_4164_'+str(itr)+'_actv01_nolast'+'.mat', biases)
